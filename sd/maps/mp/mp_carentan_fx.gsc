...
precacheFX()
{
	...
	if(level.ex_ambdustfx) level._effect["dust_wind"] = loadfx("fx/dust/dust_wind_eldaba.efx");
	if(level.ex_ambfogbankfx) level._effect["fogbank_small_duhoc"] = loadfx ("fx/misc/fogbank_small_duhoc.efx");
	if(level.ex_ambsmokefx) level._effect["thin_black_smoke_M"] = loadfx ("fx/smoke/thin_black_smoke_M.efx");
}
