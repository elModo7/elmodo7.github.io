...
precacheFX()
{
	...
	if(level.ex_ambfogbankfx) level._effect["fogbank_small_duhoc"] = loadfx ("fx/misc/fogbank_small_duhoc.efx");
	if(level.ex_ambsmokefx) level._effect["thin_light_smoke_L"] = loadfx ("fx/smoke/thin_light_smoke_L.efx");
	if(level.ex_ambfliesfx) level._effect["insects_carcass_flies"] = loadfx ("fx/misc/insects_carcass_flies.efx");
}
