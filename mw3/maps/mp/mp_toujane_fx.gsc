...
precacheFX()
{
	...
	if(level.ex_ambdustfx) level._effect["dust_wind"] = loadfx("fx/dust/dust_wind_brown.efx");
	if(level.ex_ambfogbankfx) level._effect["fogbank_small_duhoc"] = loadfx ("fx/misc/fogbank_small_duhoc.efx");
	if(level.ex_ambsmokefx) level._effect["smoke_plumeBG"] = loadfx ("fx/smoke/smoke_plumeBG_toujane.efx");
}
